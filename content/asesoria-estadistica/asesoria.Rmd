...
+ **R para:** 
  - Crear páginas web simple o con cualquier [Hugo Themes](https://themes.gohugo.io/) y publicar en [github.com](https://github.com/) o [netlify.com](https://www.netlify.com/) (si quieres ir más allá y conseguir un subdomain rbind.io también te puedo asesorar).
  - Presentaciones HTML ([ejemplo](https://guamandseduardo.rbind.io/slides/plots-ggplot2.html#1)) y PowerPoint
  - Escribir documentos .docx y .pdf
